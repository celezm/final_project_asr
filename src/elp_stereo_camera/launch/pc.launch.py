...
def generate_launch_description():
    composable_nodes = [
        ComposableNode(
            ...
            remappings=[
                ('left/image_rect', [LaunchConfiguration('left_namespace'), '/image_rect']),  # Asegurarse de usar 'image_rect'
                ('left/camera_info', [LaunchConfiguration('left_namespace'), '/camera_info']),
                ('right/image_rect', [LaunchConfiguration('right_namespace'), '/image_rect']),  # Asegurarse de usar 'image_rect'
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            name='namespace', default_value='stereo',
            description='Namespace for all components loaded'
        ),
        DeclareLaunchArgument(
            name='left_namespace', default_value='stereo/left',
            description='Namespace for the left camera'
        ),
        DeclareLaunchArgument(
            name='right_namespace', default_value='stereo/right',
